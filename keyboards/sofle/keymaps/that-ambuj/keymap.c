...
[0] = LAYOUT(
  ...
  KC_TAB,   MT(MOD_LSFT, KC_A),   MT(MOD_LALT, KC_S),    MT(MOD_LGUI, KC_D),    MT(MOD_LCTL, KC_F),    KC_G,                     KC_H,    MT(MOD_RCTL, KC_J),    MT(MOD_RGUI, KC_K),    MT(MOD_LALT, KC_L), MT(MOD_RSFT, KC_SCLN),  KC_QUOT,
...
[3] = LAYOUT(
  ...
  _______,  KC_INS,  KC_PSCR,   KC_APP,  QK_SWAP_HANDS_ON, QK_BOOT,                        KC_PGUP, QK_AUTOCORRECT_TOGGLE, QK_CAPS_WORD_TOGGLE, _______,_______, KC_BSPC,
  _______, KC_LALT,  KC_LCTL,  KC_LSFT,  QK_SWAP_HANDS_OFF, KC_CAPS,                       KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,  KC_DEL, KC_BSPC,
